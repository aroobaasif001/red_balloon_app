      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            _buildDetailRow("Amount:", controller.formattedAmount),
            _buildDetailRow("Category:", controller.formattedCategory),
            _buildDetailRow("Completed Time:", controller.formattedCompletedTime),
            _buildDetailRow("Task ID", controller.formattedTaskId),
          ],
        ),
      ),
    );
