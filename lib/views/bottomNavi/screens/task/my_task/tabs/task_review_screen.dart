...
import 'package:red_balloon_app/views/bottomNavi/screens/task/my_task/tabs/leave_feedback_screen.dart';
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  CustomText("Riyadh", fontSize: 12,fontWeight: FontVariant.regular, color: timeColor),
                  const SizedBox(width: 20),
                  const Icon(Icons.access_time,
                      size: 18, color: Colors.grey),
                  const SizedBox(width: 4),
                  CustomText("Submitted 2 min ago",
                      fontSize: 12, color: timeColor,fontWeight: FontVariant.regular,),
                ],
              ),
            ),
                ...
                children: [
                  ...
                  InkWell(
                    ...
                    child: CustomContainer(
                      height: 150,
                      width: (MediaQuery.of(context).size.width - 15 * 2 - 12) / 2,
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: GestureDetector(
                      onTap: () {
                        DialogHelpers().showApproveCompletionDialog(context: context);
                      },
                      child: CustomContainer(
                        height: 52,
                        borderRadius: BorderRadius.circular(30),
                          ...
                          child: Row(
                            ...
                            children: [
                              const Icon(Icons.check,
                                  color: historyGreenColor, size: 20),
                              const SizedBox(width: 8),
                              CustomText(
                                "Accept Proof",
                                fontWeight: FontVariant.semiBold,
